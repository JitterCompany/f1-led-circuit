    ...
    SPI: SpiBus<u8>,
{
    ...
    fn create_led_frame(red: u16, green: u16, blue: u16) -> [u8; 7] {
        [
            0b000001000, // Start code (1 bit) and gain - Regulation level 2 - 2.24 mA
            (red >> 8) as u8,
    ...
    pub async fn make_red(&mut self) -> Result<(), SPI::Error> {
        ...
        let red_led_frame = Self::create_led_frame(0x000F, 0x0000, 0x0000);
        for _ in 0..95 {
        ...
        let off_led_frame = Self::create_led_frame(0x0000, 0x0000, 0xFFFF);
        for _ in 0..95 {
