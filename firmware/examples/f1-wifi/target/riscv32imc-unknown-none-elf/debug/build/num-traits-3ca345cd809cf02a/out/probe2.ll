; ModuleID = 'probe2.bcdfe6f647fa3c32-cgu.0'
source_filename = "probe2.bcdfe6f647fa3c32-cgu.0"
...
define internal i8 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$9total_cmp17hba29c1e24c771bf2E"(ptr align 8 %self, ptr align 8 %other) unnamed_addr #0 {
start:
...
define dso_local void @_ZN6probe25probe17hd96ed7a0e6e0c37aE() unnamed_addr #1 {
start:
; call core::f64::<impl f64>::total_cmp
  %_1 = call i8 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$9total_cmp17hba29c1e24c771bf2E"(ptr align 8 @alloc_f93507f8ba4b5780b14b2c2584609be0, ptr align 8 @alloc_ef0a1f828f3393ef691f2705e817091c) #2
  ret void
}

attributes #0 = { inlinehint nounwind "frame-pointer"="all" "target-cpu"="generic-rv32" "target-features"="+m,+c,+forced-atomics" }
attributes #1 = { nounwind "frame-pointer"="all" "target-cpu"="generic-rv32" "target-features"="+m,+c,+forced-atomics" }
attributes #2 = { nounwind }

!llvm.ident = !{!0}

!0 = !{!"rustc version 1.80.0-nightly (7c52d2db6 2024-06-03)"}
